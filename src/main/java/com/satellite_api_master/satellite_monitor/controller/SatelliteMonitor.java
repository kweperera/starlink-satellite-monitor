...
public class SatelliteMonitor {
    ...
    public String monitorSatellite(@PathVariable("id") Long id, @PathVariable ("url") String url, @PathVariable ("url2") String url2) {
        ...
        satellite_data = restTemplate.exchange(catalog_url, HttpMethod.GET, entity, String.class).getBody();
        launch_data = restTemplate.exchange(location_url, HttpMethod.GET, entity, String.class).getBody();
